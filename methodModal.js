/*
function showLocomotionModalX(myId,data, attrConfig) {
  var id = data.nodes.filter(function(e){return e.n == myId})[0]
  showLocomotionModal(id,data,attrConfig)
}*/

function showLocomotionModal(locomotionId, locomotionData, attrConfig) {

  console.log("locomotionData",locomotionData)
  //console.log("__")
  console.log("attrConfig",attrConfig)
  console.log("locomotionId",locomotionId)
